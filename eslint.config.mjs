  ...
  js.configs.recommended,
  {
    languageOptions: {
      ...
      globals: {
        ...
        InstitutionMode: "readonly",
        SchoolEngine: "readonly",
        SchoolClasses: "readonly",
        SubjectMarks: "readonly",
        ResultSheet: "readonly",
        SettingsInstitution: "readonly",
        SettingsBranding: "readonly",
        SMSEngine: "readonly",
