...
const NoticeBoardModule = (() => {
  ...
  function injectBannerContainer() {
    ...
    const bannerHTML = `
      <div id="noticeBoardBanner" class="notice-container" style="display:none; position:fixed; top:60px; right:0; z-index:500; padding:12px 16px; margin:10px 20px 10px 0; border-radius:12px; font-weight:bold; box-shadow:0 4px 15px rgba(0,0,0,0.3); text-align:center; align-items:center;">
