...
const App = (() => {
  ...
  function init() {
    ...
    WFA_IDB.onReady(async () => {
      ...
      cleanupDuplicateSettings();
      // ✅ FIX: ডুপ্লিকেট "Cash" account auto-heal — setup-wizard race condition বা
      // পুরনো JSON import-এর কারণে একাধিক Cash account row তৈরি হলে, এখানে
      // সবচেয়ে বড় (real) balance-ওয়ালা রো রেখে বাকিগুলো মুছে ফেলা হয়।
