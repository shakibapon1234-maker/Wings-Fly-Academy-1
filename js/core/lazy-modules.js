...
const LazyModules = (() => {
  ...
  const MODULES = {
    ...
    'activity-log':        { src: 'js/ui/activity-log.js' },
    settings:              { src: 'js/ui/settings.js', deps: ['activity-log', 'settings-monitor'] },
    'settings-monitor':    { src: 'js/ui/settings-monitor.js' },
    ...
    'settings-student-portal': { src: 'js/ui/settings-student-portal.js' },
  ...
  const POST_LOGIN_IDLE = [
    ...
    'settings-branding', 'settings-institution', 'settings-student-portal', 'command-palette', 'notice-board', 'ai-assistant', 'pattern-lock', 'face-id',
    'sms-engine',
  ];
