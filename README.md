...
## কোড অডিট / AI রিভিউ
দৈনিক অডিটে একই “ইরর” বারবার এড়াতে **`AUDIT.md`** পড়ুন (বা অডিটারকে প্রথমে এটা পড়তে বলুন) — Supabase anon key, SW cache, ignore list সেখানে লেখা আছে।
...
## Code Update করলে
`service-worker.js` এর **`DEPLOY_ID`** বদলান (cache bust):
```js
const DEPLOY_ID = '20260523-your-label'; // আজকের তারিখ + সংক্ষিপ্ত লেবেল
```
